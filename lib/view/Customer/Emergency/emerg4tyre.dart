...
import 'package:yourmech/view/Customer/Emergency/emergrequest.dart';
import 'package:yourmech/view/Mechanic/Emergency/emergencyreq.dart';

class Emerg_4tyre extends StatefulWidget {
  const Emerg_4tyre({super.key});

  @override
  State<Emerg_4tyre> createState() => _Emerg_4tyreState();
}

class _Emerg_4tyreState extends State<Emerg_4tyre> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('vehicle_type', whereIn: ['4 tyre', 'Both'])
              .snapshots(),
