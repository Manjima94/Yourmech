...
import 'package:yourmech/view/Customer/Emergency/emer2tyre.dart';
import 'package:yourmech/view/Customer/Emergency/emerg4tyre.dart';

class UserEmergency extends StatefulWidget {
  const UserEmergency({super.key});

  @override
  State<UserEmergency> createState() => _UserEmergencyState();
}

class _UserEmergencyState extends State<UserEmergency> {
  @override
        ...
        child: Scaffold(
          ...
          body: Column(
            children: [
              ...
              Expanded(child: TabBarView(children: const [Emerg_4tyre(), Emerg_2tyre()]))
            ],
          ),
        ));
  }
